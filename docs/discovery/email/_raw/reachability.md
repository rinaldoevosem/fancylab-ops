...
3. `ToolSearch query:"email inbox thread label draft"` → returned only ClickUp / Fireflies / team-coordination tools. **Zero `mcp__claude_ai_Gmail__*` entries.**
